...
class BootstrapAdminTest extends TestCase
{
    ...
    protected function setUp(): void {
        parent::setUp();
        config(['admin.email' => 'admin@taydoautocar.com', 'admin.initial_password' => 'Bootstrap-Test123!', 'admin.name' => 'Tây Đô']);
    }
    public function test_bootstrap_creates_a_hashed_admin_that_can_login(): void {
        ...
        $this->assertTrue(Hash::check('Bootstrap-Test123!', $user->password));
        $this->postJson('/api/auth/login', ['email'=>$user->email,'password'=>'Bootstrap-Test123!'])->assertOk();
    }
